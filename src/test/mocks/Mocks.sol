...
import "../../polygon/PortalPoly.sol";
import "../../mainnet/Portal.sol";
...
contract MockPolyPortal is PortalPoly {
	function sendMessage(bytes calldata message_) external override {
...
contract MockMainPortal is Portal {
