...
async function main() {
  console.log(hre.config.solidity.compilers[0])
    ...
    // console.log("orc implementation", orcImplAddress)

    // let orc = await ProxyFac.deploy(orcImplAddress);
    // await orc.deployed()
    // console.log("orc: ", orcAddress)
    ...
    // console.log("castle impl", castleImplAddress)

    
    // let castle = await ProxyFac.deploy(castleImplAddress);
    // await castle.deployed();
    // console.log("castle address", castleAddress);
    ...
    // console.log("raids impl", raidsImplAddress)
    // let raids= await ProxyFac.deploy(raidsImplAddress)
    // console.log("raids address", raidsAddress)
    ...
    // console.log("portal impl: ", portalImplAddress)

    // let portal = await ProxyFac.deploy(portalImplAddress)
    ...
    // console.log("hallImpl: ", hallImplAddress)

    // let hall = await ProxyFac.deploy(hallImplAddress)
    // await hall.deployed()
    // console.log("hall: ", hallAddress)
